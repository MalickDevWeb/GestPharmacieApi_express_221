export const APP_MESSAGES = {
  ...
  CLIENT_FETCHED: "Client recupere avec succes.",
  CLIENT_CREATED: "Client cree avec succes.",
  CLIENT_UPDATED: "Client mis a jour avec succes.",
  CLIENT_DELETED: "Client supprime avec succes.",
  ...
  MEDICAMENT_FETCHED: "Medicament recupere avec succes.",
  MEDICAMENT_CREATED: "Medicament cree avec succes.",
  MEDICAMENT_UPDATED: "Medicament mis a jour avec succes.",
  MEDICAMENT_DELETED: "Medicament supprime avec succes.",
  VENTES_FETCHED: "Liste des ventes recuperee avec succes.",
  VENTE_FETCHED: "Vente recuperee avec succes.",
